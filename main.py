from tkinter import *
from data_manip import WordManager
...
def main() -> None:
    word_man = WordManager() 
    word_man.generate_words()
    ...
    def correct_click() ->None:
        word_man.remove_words_and_write_to_learnt_file()
        change_word()
    ...
    def change_word() ->None:
        ...
        canvas.itemconfig(word_lab, text=word_man.word_pair["French"], fill = "Black")
    ...
    def flip_card():
        ...
        canvas.itemconfig(word_lab,text = word_man.word_pair["English"], fill = "White")
    ...
    word_lab = canvas.create_text(400, 263,text= word_man.word_pair["French"], font=("Arial", 50, "bold"))
